...
namespace PrimitiveCreator
{
    ...
    public static class PrimitiveCreatorUtility
    {
        public enum MeshType
        {
            //2D shapes
            /// <summary>
            /// simple 2D quad; draws a single face (as opposed to 4-gon)
            /// </summary>
            Quad = 0,
            /// <summary>
            /// simple 2D triangle; draws a single face (as opposed to 3-gon)
            /// </summary>
            Triangle = 1,
            /// <summary>
            /// generic 2D polygon (ex: 4-gon is a quad, 5-gon is a pentagon, ...); each n is given its own triangle
            /// </summary>
            Polygon = 2,

            //Polyhedrons
            /// <summary>
            /// Platonic solid, 4-sided (i.e. a 'd4')
            /// </summary>
            Tetrahedron = 3,
            /// <summary>
            /// Platonic solid, 6-sided (i.e. a 'd6')
            /// </summary>
            Hexahedron = 4,
            /// <summary>
            /// Platonic solid, 8-sided (i.e. a 'd8')
            /// </summary>
            Octahedron = 5,
            ...
            Cube = 6,
            /// <summary>
            /// Pyramid (4 triangles, 1 quad at the bottom)
            /// </summary>
            Pyramid = 7,

            //Spheres
            /// <summary>
            /// UV sphere (i.e. a sphere consisting of quads divided between the poles)
            /// </summary>
            SphereUV = 8,
        }

        /// <summary>
        /// The current minimum vertex count.
        /// </summary>
        public static int MinimumVertexCount => PrimitiveCreatorConfig.MinimumVertexCount;
        /// <summary>
        /// The current maximum vertex count.
        /// </summary>
        public static int MaximumVertexCount => PrimitiveCreatorConfig.MaximumVertexCount;
