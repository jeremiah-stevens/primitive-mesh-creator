...
namespace PrimitiveCreator
{
    ...
    public static class MeshSaver
    {
        ...
        {
            if (mesh == null)
                throw new System.ArgumentNullException("Mesh provided is null. Please provide a valid mesh.");
            if (destination == null)
                throw new System.ArgumentNullException("Provided destination path is null. Please provide a valid path.");
