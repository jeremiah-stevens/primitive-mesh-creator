...
/* SetTri()
 *  • Indices are off; will likely require a ton of refactoring of other models to match
 * TransformMesh()
...
namespace PrimitiveCreator.MeshCreators
{
    ...
    public abstract class MeshCreator
    {
        ...
        /// </summary>
        public virtual Type _meshDetails { get { return typeof(MeshDetails); } }
